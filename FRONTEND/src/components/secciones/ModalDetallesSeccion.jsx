...
export const ModalDetallesSeccion = ({ seccion }) => {
      ...
      >
        ...
        <DrawerContent _dark={{ bg: 'primary.800' }}>
          <DrawerHeader
            ...
            textAlign="center"
          >
            INFORMACIÓN DE LA SECCION SELECCIONADO
          </DrawerHeader>
          <DrawerBody>
            <Stack direction="column" mt={6} px={[0, 10, 40, 60]}>
              ...
              >
                ...
                <Badge
                  colorScheme={seccion?.estado === true ? 'green' : 'red'}
                  variant="solid"
                  px={6}
                  py={1.5}
                  rounded="full"
                >
                  {seccion?.estado === true ? 'ACTIVO' : 'INACTIVO'}
                </Badge>
              </Stack>
              <Divider />
              <Stack
