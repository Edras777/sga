...
import { getSecciones, reset } from '../../features/seccionSlice';
import ModalAgregarSeccion from './ModalAgregarSeccion';
import ModalEditarSeccion from './ModalEditarSeccion';
import { ModalDetallesSeccion } from './ModalDetallesSeccion';
...
const Secciones = () => {
  ...
  const { secciones, isLoading, isError, message } = useSelector(
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: row => (
        <div>
          <ModalDetallesSeccion seccion={row} />
          <ModalEditarSeccion row={row} />
