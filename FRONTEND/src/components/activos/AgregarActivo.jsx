...
const AgregarActivo = () => {
  ...
  const { tipo_activos, isLoading, isError, message } = useSelector(
    state => state.tipo_activos
  );
    ...
    <>
      ...
      <form onSubmit={handleSave}>
        ...
        >
          ...
          >
            <Text fontSize="md" fontWeight={'black'}>
              Más Detalles del activo / equipo
            </Text>
            ...
            <Stack spacing={2} direction={{ base: 'column', lg: 'row' }}>
              <FormControl isRequired>
                ...
                <Input
                  ...
                  type="text"
                  onChange={e =>
                    setIndice({ ...indice, modelo: e.target.value })
                  }
                  textTransform={'uppercase'}
                />
              </FormControl>
              ...
              <FormControl isRequired>
                ...
                <Input
                  ...
                  type="text"
                  onChange={e =>
                    setIndice({ ...indice, marca: e.target.value })
                  }
                  textTransform={'uppercase'}
                />
              </FormControl>
            ...
            <Stack spacing={2} direction={{ base: 'column', lg: 'row' }}>
              <FormControl>
                ...
                <Input
                  ...
                  type="text"
                  onChange={e =>
                    setIndice({ ...indice, condicion: e.target.value })
                  }
                  textTransform={'uppercase'}
                />
              </FormControl>
