...
const DetallesEstudiante = () => {
  ...
  const queryValue = searchParams.get('to');
    ...
    <>
      ...
      >
        <Stack spacing={4} direction="row" justifyContent="space-between" p={4}>
          <HStack spacing={4} direction="row">
            <Link to={queryValue === 'estudiantes' ? '/estudiantes' : '/pagos'}>
              <IconButton
                icon={<FaArrowLeft />}
                colorScheme="blue"
                rounded="full"
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text> {estudiante?.grado?.nombre}</Text>
            </Stack>
            ...
            >
              ...
              <Text> {estudiante?.seccion?.nombre}</Text>
            </Stack>
      ...
      >
        ...
        >
          ...
          <Text>{estudiante?.observaciones}</Text>
        </Stack>
      </Stack>
      ...
      >
        <Stack justifyContent="center">
          <Text fontWeight="bold" textAlign="center">
            DETALLES ACERCA DE SUS PADRES O ENCARGADO
          </Text>
        </Stack>
        <Divider />
        <Stack
