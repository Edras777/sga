      ...
      >
        ...
        <DrawerContent _dark={{ bg: 'primary.800' }}>
          <DrawerHeader
            ...
            textAlign="center"
          >
            INFORMACIÓN BÁSICA DEL LIBRO SELECCIONADO
          </DrawerHeader>
          <DrawerBody>
              ...
              >
                <Stack direction="column" mt={6} spacing={2} w="full">
                  ...
                  >
                    ...
                    <Text>
                      {libro_prestamo.estudiante
                        ? libro_prestamo.estudiante?.nombres +
                          ' ' +
                          libro_prestamo.estudiante?.apellidos
                        : libro_prestamo.docente?.nombres +
                          ' ' +
                          libro_prestamo.docente?.apellidos}
                    </Text>
                  </Stack>
                  <Divider />
                  <Stack
                  ...
                  >
                    ...
                    <Text>
                      {libro_prestamo.estudiante
                        ? libro_prestamo.estudiante?.CUI
                        : libro_prestamo.docente?.CUI}
                    </Text>
                  </Stack>
                  <Divider />
                  <Stack
                  ...
                  >
                    ...
                    <Text>
                      {Moment(libro_prestamo?.fecha_prestamo).format(
                  ...
                  >
                    ...
                    <Badge
                      colorScheme={
                        libro_prestamo?.estado === 'PRESTADO' ? 'red' : 'blue'
                      }
                      variant="solid"
                      px={6}
                      py={1.5}
                        ...
                        <AccordionButton>
                          <Box as="span" flex="1" textAlign="left">
                            <Text fontWeight="bold" alignSelf={'center'}>
                              DETALLES DE LA ENTREGA DEL LIBRO
                            </Text>
                          </Box>
                          {isExpanded ? (
                      ...
                      <>
                        <h2>
                          <AccordionButton>
                            <Box as="span" flex="1" textAlign="left">
                              <Text fontWeight="bold" alignSelf={'center'}>
                                DETALLES DE LA DEVOLUCIÓN DEL LIBRO
                              </Text>
                            </Box>
                            {isExpanded ? (
                              <MinusIcon fontSize="14px" />
                        ...
                        <AccordionPanel pb={4}>
                          <Stack direction="column" spacing={2} w="full" p={6}>
                            ...
                            >
                              ...
                              <Text>
                                {Moment(
                                  libro_prestamo?.fecha_devolucion
                            ...
                            >
                              <Text fontWeight="bold">
                                DESCRIPCION DE LA DEVOLUCIÓN:
                              </Text>
                              <Text>
                                {libro_prestamo?.descripcion_devolucion}
                              </Text>
                            </Stack>
                            <Divider />
                          </Stack>
