        ...
        <form onSubmit={handleSave}>
          <ModalContent _dark={{ bg: 'primary.900' }} borderRadius="none">
            <ModalHeader textAlign="center">
              REGISTRAR DEVOLUCIÓN DEL PRESTAMO
            </ModalHeader>
            <ModalCloseButton />
            <ModalBody>
              <Stack
              ...
              >
                ...
                <FormControl isRequired>
                  ...
                  <Input
                    type={'datetime-local'}
                    onChange={e =>
                      setIndice({ ...indice, fecha_devolucion: e.target.value })
                    }
                  />
                </FormControl>
              </Stack>
                ...
                <FormControl>
                  ...
                  <Textarea
                    ...
                    onChange={e =>
                      setIndice({
                        ...indice,
                        descripcion_devolucion: e.target.value,
                      })
                    }
                  />
                </FormControl>
            ...
            <ModalFooter>
              ...
              <Button
                isDisabled={!indice.fecha_devolucion || !indice.codigo}
                colorScheme="messenger"
                _dark={{
                  bg: 'messenger.500',
                  color: 'white',
