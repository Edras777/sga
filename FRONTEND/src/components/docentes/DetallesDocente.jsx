...
const DetallesDocente = ({ location }) => {
  ...
  const { docente, isLoading, isError, message } = useSelector(
        ...
        >
          ...
          >
            ...
            >
              ...
              <Text>
                {Moment(docente?.createdAt).format('DD-MM-YYYY - hh:mm:ss A')}
              </Text>
            </Stack>
            <Divider />
            <Stack
        ...
        >
          ...
          <Text>
            {!docente?.fecha_nacimiento
              ...
              : Moment.utc(docente?.fecha_nacimiento).format(
